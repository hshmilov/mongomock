...
time docker pull $NEXURL/axonius/weave:2.6.0
time docker pull $NEXURL/axonius/weaveexec:2.6.0
time docker pull $NEXURL/axonius/weavedb
time docker tag $NEXURL/axonius/axonius-base-image:latest nexus.axonius.lan/axonius/axonius-base-image:latest

...
class SettingsPage(Page):
    ...
    CERT_ELEMENT_SELECTOR = '#app > .x-page > .body > div > div > div.x-tab.active.global-settings-tab' \
                            ' > .tab-settings > .x-form > .x-array-edit > div:nth-child(1) > div > div' \
                            ' > div:nth-child(4) > div > div > input[type="file"] '
    PRIVATE_ELEMENT_SELECTOR = '#app > .x-page > .body > div > div > div.x-tab.active.global-settings-tab' \
                               ' > .tab-settings > .x-form > .x-array-edit > div:nth-child(1) > div > div' \
                               ' > div:nth-child(5) > div > div > input[type="file"] '
    CERT_ELEMENT_FILENAME_SELECTOR = '#app > .x-page > .body > div > div > div.x-tab.active.global-settings-tab' \
                                     ' > .tab-settings > .x-form > .x-array-edit > div:nth-child(1) > div > div' \
                                     ' > div:nth-child(4) > div > div > div.file-name '
    PRIVATE_ELEMENT_FILENAME_SELECTOR = '#app > .x-page > .body > div > div > div.x-tab.active.global-settings-tab' \
                                        ' > .tab-settings > .x-form > .x-array-edit > div:nth-child(1) > div > div' \

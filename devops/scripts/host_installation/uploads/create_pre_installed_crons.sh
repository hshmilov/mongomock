...
echo "@reboot cd /home/ubuntu/cortex/devops/scripts/watchdog/tasks && ./chef_client_task_host start" >> "$TMP_CRONTAB"
echo "@reboot cd /home/ubuntu/cortex/devops/scripts/watchdog/tasks && ./reset_passwords_task_host start" >> "$TMP_CRONTAB"

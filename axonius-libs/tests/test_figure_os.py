...
def test_windows_os():
    data = {
        ...
        'Microsoft Windows Server 2012 R2 x64 Server Standard (6.3.9600)':
            {'type': 'Windows', 'distribution': 'Server 2012 R2', 'bitness': 64, 'is_windows_server': True,
        ...
        'Microsoft Windows Server 2008 R2 x64 Server Standard Service Pack 1 (6.1.7601)':
            {'type': 'Windows', 'distribution': 'Server 2008 R2', 'bitness': 64, 'is_windows_server': True,
        ...
        'Microsoft Windows NT Server 10.0.9999': {'type': 'Windows', 'distribution': 'Server 2019', 'bitness': None,
                                                  'is_windows_server': True,
                                                  'os_str': 'Microsoft Windows NT Server 10.0.9999'.lower()},

        'Microsoft Windows NT Workstation 6.3': {'type': 'Windows', 'distribution': '8.1', 'bitness': None,
                                                 'is_windows_server': False,

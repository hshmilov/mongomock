...
from axonius.consts.plugin_consts import PLUGIN_NAME, PLUGIN_UNIQUE_NAME, CORE_UNIQUE_NAME, \
    ...
    MASTER_INSTANCE_CONTROL_PLUGIN_UNIQUE_NAME, GUI_PLUGIN_NAME, PARALLEL_ADAPTERS, THREAD_SAFE_ADAPTERS, \
    DEVICE_LOCATION_MAPPING, CSV_IP_LOCATION_FILE, CONNECTION_DISCOVERY, CONNECTION_DISCOVERY_SCHEMA_NAME, WEEKDAYS, \

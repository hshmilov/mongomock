...
class ADEntity(object):
    ...
    ad_admin_count = Field(int, 'AD Admin Count')
    ...
    extension_attribute_1_date = Field(datetime.datetime, 'Extension Attribute 1 Date')
    extension_attribute_2_date = Field(datetime.datetime, 'Extension Attribute 2 Date')
    extension_attribute_3_date = Field(datetime.datetime, 'Extension Attribute 3 Date')
    extension_attribute_4_date = Field(datetime.datetime, 'Extension Attribute 4 Date')
    extension_attribute_5_date = Field(datetime.datetime, 'Extension Attribute 5 Date')
    extension_attribute_6_date = Field(datetime.datetime, 'Extension Attribute 6 Date')
    extension_attribute_7_date = Field(datetime.datetime, 'Extension Attribute 7 Date')
    extension_attribute_8_date = Field(datetime.datetime, 'Extension Attribute 8 Date')
    extension_attribute_9_date = Field(datetime.datetime, 'Extension Attribute 9 Date')
    extension_attribute_10_date = Field(datetime.datetime, 'Extension Attribute 10 Date')
    extension_attribute_11_date = Field(datetime.datetime, 'Extension Attribute 11 Date')
    extension_attribute_12_date = Field(datetime.datetime, 'Extension Attribute 12 Date')
    extension_attribute_13_date = Field(datetime.datetime, 'Extension Attribute 13 Date')
    extension_attribute_14_date = Field(datetime.datetime, 'Extension Attribute 14 Date')
    extension_attribute_15_date = Field(datetime.datetime, 'Extension Attribute 15 Date')
    extension_attribute_16_date = Field(datetime.datetime, 'Extension Attribute 16 Date')
    extension_attribute_17_date = Field(datetime.datetime, 'Extension Attribute 17 Date')
    extension_attribute_18_date = Field(datetime.datetime, 'Extension Attribute 18 Date')
    extension_attribute_19_date = Field(datetime.datetime, 'Extension Attribute 19 Date')
    # Other

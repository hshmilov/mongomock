...
class SnowDeviceAdapter(DeviceAdapter):
    ...
    u_director = Field(str, 'Support Group Director')
    u_manager = Field(str, 'Support Group Manager')
    support_group_manager_company = Field(str, 'Support Group Manager Company')
    support_group_manager_business_segment = Field(str, 'Support Group Manager Business Segment')
    ...
    u_employee_type = Field(str, 'Employee Type')
    u_job_function = Field(str, 'Job Function')
    u_legal_entity_name = Field(str, 'Legal Entity Name')
    u_organization_segment = Field(str, 'Organization Segment')
    u_sub_organization_segment = Field(str, 'Sub Organization Segment')
    u_labor_model = Field(str, 'Labor Model')
    u_parent_organization_name = Field(str, 'Parent Organization Name')
    u_organization_name = Field(str, 'Organization Name')
    u_organization_id = Field(str, 'Organization ID')

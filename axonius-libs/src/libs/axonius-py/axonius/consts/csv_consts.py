...
IDENTIFIERS = {
    ...
    'serial': ['serial', 'serialnumber', 'sn', 'hostserialnumber', 'deviceserialnumber', 'serial#',
               'endpointserialnumber', 'pedserialnumber', 'registerserialnumber', 'serialnum'],
    ...
    'last_seen': ['lastmessagetime', 'lastdiscoveredtime', 'lastseen', 'endpointlfdt', 'lastdiscoverydate',
    ...
    'etcissue': ['etcissue'],
    'cve_id': ['cve', 'cveid', 'cvelist', 'vulners'],

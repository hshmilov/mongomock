...
METRICS_HOST_PATH = Path(CORTEX_PATH) / f'plugins/instance_control/metrics/{METRICS_FILENAME}'
METRICS_CONTAINER_PATH = Path(f'/home/axonius/app/metrics/{METRICS_FILENAME}')

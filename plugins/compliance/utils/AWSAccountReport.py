...
# But basically for order reasons we gotta replace AccountReport in AWSAccountReport anyware in aws_cis
class AWSAccountReport(AccountReport):
    ...
    def add_rule_error(self, *args, **kwargs):
        return self.add_rule_error(*args, cis_json_dict=self.aws_rules_by_section, **kwargs)

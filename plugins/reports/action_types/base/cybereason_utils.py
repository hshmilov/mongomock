...
def cybereason_action(action_name, current_result, node_id, tags_dict=None):
        ...
        try:
            for adapter_data in entry['adapters']:
                if adapter_data['plugin_name'] == ADAPTER_NAME:
                    ...
                    cybereason_response_dict['machine_name'] = machine_name
                    cybereason_response_dict['tags_dict'] = tags_dict

<template>
    <x-modal v-if="launch" @confirm="handleConfirm" @close="handleClose" :disabled="disabled"
...
<script>
    ...
    export default {
        ...
        props: {
            handleSave: {required: true}, message: {default: 'Save complete'}, launch: {default: false},

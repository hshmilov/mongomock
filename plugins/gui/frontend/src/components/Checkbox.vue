<template>
    <div class="checkbox" :class="{ 'checked': checked }" @click.stop="$refs.checkboxInput.click()">
        <input type="checkbox" ref="checkboxInput" :checked="checked" @change="updateChecked" :disabled="disabled">

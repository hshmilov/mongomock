<template>
    <x-page :breadcrumbs="[
        ...
        <div class="explorer-results">
            <x-data-table v-for="entity in entities" :module="entity.name" section="explorer"
...
<script>
    ...
    import xExplorerSearch from './ExplorerSearch.vue'
    ...
    export default {
        ...
        components: { xPage, xExplorerSearch, xDataTable },
        computed: {
            ...mapState({
                entityFilters(state) {
                    let entityToFilter = {}

	...
	state: {
		...
		fields: {
			...
			unique: {
				...
				"qualys_adapter": [
					{control: "text",path: "adapters.data.address",name:"Qualys.address"},
					{control: "text",path: "adapters.data.agentInfo.activatedModule",name:"Qualys.agentInfo.activatedModule"},
					{control: "text",path: "adapters.data.agentInfo.activationKey.activationId",name:"Qualys.agentInfo.activationKey.activationId"},
					{control: "text",path: "adapters.data.agentInfo.activationKey.title",name:"Qualys.agentInfo.activationKey.title"},
					{control: "number",path: "adapters.data.agentInfo.agentConfiguration.id",name:"Qualys.agentInfo.agentConfiguration.id"},
					{control: "text",path: "adapters.data.agentInfo.agentConfiguration.name",name:"Qualys.agentInfo.agentConfiguration.name"},
					{control: "text",path: "adapters.data.agentInfo.agentId",name:"Qualys.agentInfo.agentId"},
					{control: "text",path: "adapters.data.agentInfo.agentVersion",name:"Qualys.agentInfo.agentVersion"},
					{control: "text",path: "adapters.data.agentInfo.chirpStatus",name:"Qualys.agentInfo.chirpStatus"},
					{control: "text",path: "adapters.data.agentInfo.connectedFrom",name:"Qualys.agentInfo.connectedFrom"},
					{control: "text",path: "adapters.data.agentInfo.lastCheckedIn",name:"Qualys.agentInfo.lastCheckedIn"},
					{control: "text",path: "adapters.data.agentInfo.location",name:"Qualys.agentInfo.location"},
					{control: "text",path: "adapters.data.agentInfo.locationGeoLatitude",name:"Qualys.agentInfo.locationGeoLatitude"},
					{control: "text",path: "adapters.data.agentInfo.locationGeoLongtitude",name:"Qualys.agentInfo.locationGeoLongtitude"},
					{control: "text",path: "adapters.data.agentInfo.platform",name:"Qualys.agentInfo.platform"},
					{control: "text",path: "adapters.data.agentInfo.status",name:"Qualys.agentInfo.status"},
					{control: "text",path: "adapters.data.created",name:"Qualys.created"},
					{control: "number",path: "adapters.data.id",name:"Qualys.id"},
					{control: "text",path: "adapters.data.lastLoggedOnUser",name:"Qualys.lastLoggedOnUser"},
					{control: "text",path: "adapters.data.lastSystemBoot",name:"Qualys.lastSystemBoot"},
					{control: "text",path: "adapters.data.modified",name:"Qualys.modified"},
					{control: "text",path: "adapters.data.name",name:"Qualys.name"},
					{control: "text",path: "adapters.data.os",name:"Qualys.os"},
					{control: "text",path: "adapters.data.timezone",name:"Qualys.timezone"},
					{control: "number",path: "adapters.data.totalMemory",name:"Qualys.totalMemory"},
					{control: "text",path: "adapters.data.trackingMethod",name:"Qualys.trackingMethod"},
					{control: "text",path: "adapters.data.type",name:"Qualys.type"}
        ],
				"jamf_adapter": [

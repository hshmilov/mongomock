    ...
    <div class="row"  style="height: 100vh">
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body"  style="height: 80vh">
                    <h1 style="margin-bottom: 16px; color: #4796e4"><img src="/src/assets/images/general/about.png" style="height: 40px; margin-right: 8px;"/> About</h1>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body"  style="height: 80vh">
                    <h1 style="color: #4796e4"><img src="/src/assets/images/general/results.png" style="height: 40px; margin-right: 8px;"/> Results</h1>

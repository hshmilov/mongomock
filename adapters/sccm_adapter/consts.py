...
COMPUTER_SYSTEM_QUERY = 'Select ResourceID, Caption0, Model0, SystemType0, UserName0, CurrentTimeZone0, PrimaryOwnerContact0, PrimaryOwnerName0 from v_GS_COMPUTER_SYSTEM'
...
QUERY_PATCH = 'Select ResourceID, Description0, FixComments0, InstallDate0, HotFixID0, InstalledOn0 from v_GS_QUICK_FIX_ENGINEERING'
QUERY_PATCH_2 = 'Select ResourceID, Description0, FixComments0, InstallDate0, HotFixID0, InstalledOn0 from v_HS_QUICK_FIX_ENGINEERING'
...
BIOS_QUERY = 'Select ResourceID, SerialNumber0, Manufacturer0, ReleaseDate0 from v_GS_PC_BIOS'
...
DISKS_QUERY = 'select ResourceID, FreeSpace0, Size0, DeviceID0 from v_GS_LOGICAL_DISK'
...
SHARES_QUERY = 'select ResourceID, Name0, Path0, Type0, Description0, Status0 from v_GS_SHARE'
COMPLIANCE_QUERY = 'select ResourceID, Status from v_UpdateComplianceStatus'
LOCAL_ADMIN_QUERY = 'select ResourceID, name0 , account0, domain0, Category0 from v_gs_localgroupmembers0'
...
SVC_QUERY = 'select DisplayName0, PathName0, ServiceType0, StartMode0, ResourceID, State0 from v_GS_SERVICE '

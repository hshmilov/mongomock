...
def start(id, url, ua, ga, source):
    ...
    if version == '0':
        ...
        xml_files = ['administrator/manifests/files/joomla.xml', 'language/en-GB/en-GB.xml', 'administrator/components/com_content/content.xml',
                     'administrator/components/com_plugins/plugins.xml', 'administrator/components/com_media/media.xml', 'mambots/content/moscode.xml']
    ...
    # Detection method 3
    if version == '0':
        other_files = ['language/en-GB/en-GB.xml', 'templates/system/css/system.css', 'media/system/js/mootools-more.js',
        ...
        for file in other_files:
            ...
            if file_source[0] == '1':
                ...
                # Joomla version 1.6
                j16 = ['system.css 20196 2011-01-09 02:40:25Z ian',
                       'MooTools.More={version:"1.3.0.1"', 'en-GB.ini 20196 2011-01-09 02:40:25Z ian', 'en-GB.ini 20990 2011-03-18 16:42:30Z infograf768', '20196 2011-01-09 02:40:25Z ian']
                for j in j16:
                ...
                # Joomla version 1.7
                j17 = ['system.css 21322 2011-05-11 01:10:29Z dextercowley',
                       'MooTools.More={version:"1.3.2.1"', '22183 2011-09-30 09:04:32Z infograf768', '21660 2011-06-23 13:25:32Z infograf768']
                for j in j17:
                    rsearch = re.search(j, file_source[1])
                    if rsearch is not None:
            ...
            # Joomla version 1.0
            j10 = ['(Copyright (C) 2005 - 200(6|7))', '47 2005-09-15 02:55:27Z rhuk', '423 2005-10-09 18:23:50Z stingrey', '1005 2005-11-13 17:33:59Z stingrey', '1570 2005-12-29 05:53:33Z eddieajau',
                   '2368 2006-02-14 17:40:02Z stingrey', '1570 2005-12-29 05:53:33Z eddieajau', '4085 2006-06-21 16:03:54Z stingrey', '4756 2006-08-25 16:07:11Z stingrey', '5973 2006-12-11 01:26:33Z robs', '5975 2006-12-11 01:26:33Z robs']
            for j in j10:
                rsearch = re.search(j, file_source[1])
                if rsearch is not None:

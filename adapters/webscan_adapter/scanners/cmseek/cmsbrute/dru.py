...
import webscan_adapter.scanners.cmseek.cmseekdb.basic as cmseek  # I don't feel like commenting
...
def start():
    ...
    if drucnf != '1':
        ...
        if druloginsrc[0] == '1' and '<form' in druloginsrc[1] and 'name="form_id" value="' in druloginsrc[1]:
            ...
            druparamuser = ['']
            rawuser = input(
                "[~] Enter Usernames with coma as separation without any space (example: cris,harry): ").split(',')
            for rusr in rawuser:

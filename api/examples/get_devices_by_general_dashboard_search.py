...
FILTER = 'adapters == regex("{0}", "i") or specific_data.data.hostname == regex("{0}", "i") or ' \
         'specific_data.data.name == regex("{0}", "i") or specific_data.data.os.type == regex("{0}", "i") ' \
         'or specific_data.data.network_interfaces.ips == regex("{0}", "i") or ' \
         'specific_data.data.network_interfaces.mac == regex("{0}", "i") or labels == regex("{0}", "i") or ' \
         'specific_data.data.last_used_users == regex("{0}", "i")'
